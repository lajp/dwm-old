...
static const char *nextcmd[] = { "tizonia-ctl.sh", "next", NULL };
static const char *prevcmd[] = { "tizonia-ctl.sh", "prev", NULL };
static const char *playpausecmd[] = { "tizonia-ctl.sh", "pp", NULL };
